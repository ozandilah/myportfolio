...
const RoundFour = () => {
    return (
        <div className="w-[800px] h-[800px] rounded-full absolute top-0 right-1/3">
            <div className="w-full h-full relative animate-reverse-spin">
                ...
                <div
                    className="w-52 h-52 rounded-full bg-gradient-to-t from-orange-700 to-lime-600 absolute -bottom-10
            left-16 blur-3xl"></div>
